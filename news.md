      ...
      <div class="col-lg-8">
        ...
        <article class="card mb-4 border-0 shadow-sm" data-aos="fade-up">
          <div class="card-body p-4">
            ...
            <p>The four-year project, funded by ANR under the PEPR Sante Numerique program of France 2030, aims to develop digital twin technology for precision neurology, focusing on brain tumors and cerebral small vessel disease.</p>
          </div>
        </article>
        ...
        <article class="card mb-4 border-0 shadow-sm" data-aos="fade-up" data-aos-delay="200">
          <div class="card-body p-4">
            <div class="d-flex align-items-center mb-3">
              <span class="badge bg-info text-dark me-2">Opportunity</span>
              <span class="text-muted small">Coming Soon</span>
            </div>
            <h3>PhD and Postdoc Positions Available</h3>
            ...
            <p>Check back soon for application details or <a href="{{ '/contact/' | relative_url }}">contact us</a> for more information.</p>
          </div>
        </article>
      </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="d-flex gap-2">
              <a href="https://twitter.com/braintwin_eu" target="_blank" rel="noopener" class="btn btn-outline-primary btn-sm">
