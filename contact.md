  ...
  <div class="container">
    <div class="row g-4 align-items-start">
      ...
      <div class="col-lg-7">
        ...
        <!-- Make the header area more compact -->
        <h2 class="section-title mb-2">Get in Touch</h2>
        <p class="text-muted mb-3">
          Inquiries about collaboration, research opportunities, and general questions about BRAINTWIN.
        </p>

        <!-- Compact “Email” card (reduced padding + smaller heading) -->
        <div class="card border-0 shadow-sm mb-3">
          <div class="card-body p-3">
            ...
            <div class="mt-2 small">
              <div class="text-muted">For general inquiries:</div>
              <a href="mailto:braintwin@icm-institute.org">braintwin@icm-institute.org</a>
            </div>
          </div>
        </div>

        <!-- Project Coordinator: compact + includes X1 Y1 shorthand -->
        <div class="card border-0 shadow-sm mb-3">
          <div class="card-body p-3">
            <div class="d-flex align-items-center justify-content-between">
              <h6 class="mb-0">
                <i class="bi bi-person-fill text-primary me-2"></i>Project Coordinator
              </h6>
      ...
      <div class="col-lg-5">
        ...
        <div class="card border-0 shadow-sm mb-3">
          <div class="card-body p-4">
            <h5 class="mb-2">
              <i class="bi bi-buildings me-2 text-primary"></i>Partner Institution Contacts
            </h5>
        ...
        <!-- OPEN POSITIONS: directly below partner contacts, with minimal spacing.
             Also: prevent footer overlap by removing any large margins/padding. -->
        <div class="card border-0 shadow-sm mb-0" id="positions">
          <div class="card-body p-4">

            <div class="d-flex align-items-center justify-content-between mb-3">
              <h5 class="mb-0">
                <i class="bi bi-briefcase me-2 text-primary"></i>Open Positions
              </h5>
...
<!-- Strongly recommended CSS patch (put in assets/css/style.css)
     Ensures your footer is never covered if your theme has large section padding or odd positioning rules. -->
<!--
#contact.section { padding-bottom: 2.5rem; }
#positions { scroll-margin-top: 90px; }
